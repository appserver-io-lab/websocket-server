...
/**
 * AppserverIo\Lab\WebSocketServer\HandlerConfiguration
 *
 * NOTICE OF LICENSE
 *
...
class HandlerConfiguration implements HandlerConfigInterface
{
     ...
     *
     * @var \AppserverIo\Lab\WebSocketProtocol\HandlerContextInterface
     */
     ...
     *
     * @param \AppserverIo\Lab\WebSocketProtocol\HandlerContextInterface $handlerContext The handler context instance
     *
     * @return void
     */
